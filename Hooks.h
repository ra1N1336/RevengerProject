...
public:
	...
	void Hook()
	{
		...
		Font_Vermin_Vibes = Interfaces.pSurface->Create_Font();
		Font_Title = Interfaces.pSurface->Create_Font();
		Font_Tabplus = Interfaces.pSurface->Create_Font();
		Font_Tab = Interfaces.pSurface->Create_Font();
		Font_ESP = Interfaces.pSurface->Create_Font();
		Interfaces.pSurface->SetFontGlyphSet(Font_Vermin_Vibes, "Verdana", 13, 200, 0, 0, FONTFLAG_ANTIALIAS);
		Interfaces.pSurface->SetFontGlyphSet(Font_Tabplus, "Vermin Vibes", 35, 600, 0, 0, FONTFLAG_ANTIALIAS);
		Interfaces.pSurface->SetFontGlyphSet(Font_Tab, "Vermin Vibes", 16, 600, 0, 0, FONTFLAG_ANTIALIAS);
		Interfaces.pSurface->SetFontGlyphSet(Font_Title, "Vermin Vibes", 13, 600, 0, 0, FONTFLAG_ANTIALIAS);
		Interfaces.pSurface->SetFontGlyphSet(Font_ESP, "Verdana", 12, 250, 0, 0, FONTFLAG_DROPSHADOW);
