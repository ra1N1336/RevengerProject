...
void rainbow() {
	...
	green = abs(255 * sin(value));
	{
		...
		if (Settings.GetSetting(Tab_Other, Other_Misc_Sky_Rainbow)) {

			Settings.SetSetting(Tab_Other, Other_Misc_Sky_Red, red);
			Settings.SetSetting(Tab_Other, Other_Misc_Sky_Green, green);
			Settings.SetSetting(Tab_Other, Other_Misc_Sky_Blue, blue);
		}
		if (Settings.GetSetting(Tab_Other, Other_Misc_CustomWalls_Rainbow)) {

			Settings.SetSetting(Tab_Other, Other_Misc_CustomWalls_Red, red);
			Settings.SetSetting(Tab_Other, Other_Misc_CustomWalls_Green, green);
			Settings.SetSetting(Tab_Other, Other_Misc_CustomWalls_Blue, blue);
		}
		if (Settings.GetSetting(Tab_Other, Other_Misc_Wire_Rainbow)) {

			Settings.SetSetting(Tab_Other, Other_Misc_Wire_Red, red);
			Settings.SetSetting(Tab_Other, Other_Misc_Wire_Green, green);
			Settings.SetSetting(Tab_Other, Other_Misc_Wire_Blue, blue);
		}
		if (Settings.GetSetting(Tab_Other, Other_Misc_Hands_Rainbow)) {

			Settings.SetSetting(Tab_Other, Other_Misc_Hands_Red, red);
			Settings.SetSetting(Tab_Other, Other_Misc_Hands_Green, green);
			Settings.SetSetting(Tab_Other, Other_Misc_Hands_Blue, blue);
		}
	...
	void Draw()
	{
		if (Menu.GetCurret_Tab() == Tab)
		{
			if (Menu.GetCurret_SubTab() == Sub || Sub == -1) {
				...
				Interfaces.pSurface->DrawSetColor(87, 82, 82, 255);
				...
				{
					Interfaces.pSurface->DrawSetColor(232, 0, 0, 255);
...
public:
	void Draw()
	{
		if (Menu.GetCurret_Tab() == Tab)
		{
			...
			Interfaces.pSurface->DrawT(this->pos.x, this->pos.y - 12, CColor(0, 255, 0, 255), Hacks.Font_Vermin_Vibes, false, "%s: %.1f", this->Name, (float)Settings.GetMenuSetting(this->Tab, this->Setting));
		}
	}
	...
	void Draw()
	{
		if (Tab == Menu.GetCurret_Tab())
		{
			if (Menu.GetCurret_SubTab() == Sub || Sub == -1) {
				...
				Interfaces.pSurface->DrawSetColor(195, 0, 0, 235);
				...
				if (this->Dropping)
				{
					for (int i = 1; i < this->Amount; i++)
					{
						Interfaces.pSurface->DrawSetColor(165, 0, 0, 255); //dark top color
						Interfaces.pSurface->DrawFilledRect(this->pos.x, this->pos.y + (20 * i), this->pos.x + 100, this->pos.y + (20 * i) + 21);
						Interfaces.pSurface->DrawSetColor(0, 0, 0, 235);
	...
	void Draw()
	{
		if (Menu.GetCurret_Tab() == Tab)
		{
			if (Menu.GetCurret_SubTab() == Sub || Sub == -1) {
				...
				//Interfaces.pSurface->DrawT(this->pos.x, this->pos.y - 12, CColor(0, 255, 0, 255), Hacks.Font_Vermin_Vibes, false, "%s", this->Name);
				...
				{
					Interfaces.pSurface->DrawT(this->pos.x + 40, this->pos.y + 3, CColor(255, 0, 0, 255), Hacks.Font_Vermin_Vibes, true, "<PRESS>");
				}
				else
				{
					if (Settings.GetMenuSetting(this->Tab, this->Setting) == -1)
						Interfaces.pSurface->DrawT(this->pos.x + 40, this->pos.y + 3, CColor(0, 255, 0, 255), Hacks.Font_Vermin_Vibes, true, "<UNSET>");
					else
					{
						char* NameOfKey = KeyStrings[(int)Settings.GetMenuSetting(this->Tab, this->Setting)];
						Interfaces.pSurface->DrawT(this->pos.x + 40, this->pos.y + 3, CColor(0, 255, 0, 255), Hacks.Font_Vermin_Vibes, true, NameOfKey);
					}
				}
			}
		}
...
public:
	void Update()
	{
		pos.x = Menu.pos.x - 115;
		pos.y = Menu.pos.y + ((250 / Tab_Count) * Tab);
	...
	void Draw()
	{
		if (Tab == Menu.GetCurret_Tab())
		{
			if (SubTab == Menu.GetCurret_SubTab() || SubTab == -1) {
				...
				Interfaces.pSurface->DrawT(pos.x + 10, pos.y - 7, CColor(232, 0, 0, 255), Hacks.Font_Vermin_Vibes, false, Name);
...
void SetupMenu()
{
	...
	*/
	...
	AddNewMenuBox("AntiAim", 170, 80, 130, 300, Tab_Ragebot);
	{
		...
		std::vector<char*> Antiaim_X = { "", "","Emotion", "RevenDown", "ReveUp", "ReveEye", "RevenFakeD", "Down Fake", "Head Glitch", "Emotion Fake", "Zero", "ReveT", "ReveTT", "Fake Jitter", "Custom AA", "ULTRAaa(Beta)" };
		AddNewDropbox(175, 120, Tab_Ragebot, AntiAim_X, "Antiaim Pitch", 16, Antiaim_X);
		std::vector<char*> Antiaim_Y = { "", "","Backwards", "Right", "Left", "Forward", "Slow Spin", "Dynamic Real", "Inverse Switch", "Half Right Jitter", "Fake spin", "Half Right", "Half Left", "ReveT", "RevePrivate1", "RevePrivate2", "Custom Real", "Custom Fake", "ReveJitter" };
	...
	AddNewSubTab("OTHER", Tab_Misc, Sub_Other);
	{
		AddNewSubMenuBox("Movement", 20, 80, 130, 300, Tab_Misc, Sub_Misc);
		{
			...
			AddNewSubSlider(25, 315, 0, 13, 0, "FLag Ammount", Tab_Misc, Misc_FakelagAmmount, Sub_Misc);
		}
		AddNewSubMenuBox("Vanity", 170, 80, 130, 300, Tab_Misc, Sub_Misc);
		{
			...
			std::vector<char*> Spams1 = { "Off", "Advert", "2long4u", "' '", "Advert/Coloured/", "KIDHOOK", "pu sucks", "Advert /Crew/", "SKAM WARE" ,"Advert/Site/", };
			...
			std::vector<char*> Spams2 = { "Off", "Advert", "Advert /Hide/", "Advert /Action/", "Advert /Meme Style/", "Advert /Flash/", "Advert /Crew/" };
		...
		AddNewSubMenuBox("Functions", 320, 80, 130, 200, Tab_Misc, Sub_Misc);
		{
	...
	{
		// OTHER
		AddNewSubMenuBox("FUN STUFF & OTHER", 20, 80, 600, 300, Tab_Misc, Sub_Other);
		{
			...
			AddNewSubButton(Tab_Misc, Misc_Bypass, false, 25, 150, "sv_cheats 1", Sub_Other);
	...
	AddNewMenuBox("ESP", 20, 80, 130, 300, Tab_Visuals);
	{
		...
		AddNewButton(Tab_Visuals, Vis_DropWeapon, false, 25, 210, "Dropped Weapons");
		AddNewButton(Tab_Visuals, Vis_Background, false, 25, 230, "Health");
		AddNewButton(Tab_Visuals, Vis_Health, false, 25, 250, "Health&ArmorBar");
		AddNewButton(Tab_Visuals, Vis_AimLines, false, 25, 270, "Aim Lines");
		AddNewButton(Tab_Visuals, Vis_Skel, false, 25, 290, "Skeleton ESP");
	...
	AddNewMenuBox("Misc", 320, 80, 130, 300, Tab_Visuals);
	{
		...
		AddNewButton(Tab_Visuals, Vis_Rainbow, false, 325, 110, "Enable Rainbow");
	}
	...
	{//Colours 2
		...
		AddNewSubMenuBox("Chams Enemy Visible", 5, 70, 130, 140, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(15, 90, 0, 255, 0, "Red", Tab_Other, Other_Cham_Enemy_Visible_Red, Sub_Colour2);
			AddNewSubSlider(15, 120, 0, 255, 255, "Green", Tab_Other, Other_Cham_Enemy_Visible_Green, Sub_Colour2);
			AddNewSubSlider(15, 150, 0, 255, 255, "Blue", Tab_Other, Other_Cham_Enemy_Visible_Blue, Sub_Colour2);
			AddNewSubSlider(15, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Enemy_Visible_Alpha, Sub_Colour2);
		}
		AddNewSubMenuBox("Chams Enemy Invisible", 5, 220, 130, 140, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(15, 240, 0, 255, 255, "Red", Tab_Other, Other_Cham_Enemy_inVisible_Red, Sub_Colour2);
			AddNewSubSlider(15, 270, 0, 255, 255, "Green", Tab_Other, Other_Cham_Enemy_inVisible_Green, Sub_Colour2);
			AddNewSubSlider(15, 300, 0, 255, 0, "Blue", Tab_Other, Other_Cham_Enemy_inVisible_Blue, Sub_Colour2);
			AddNewSubSlider(15, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Enemy_inVisible_Alpha, Sub_Colour2);
		}
		AddNewSubButton(Tab_Other, Other_Cham_Enemy_Rainbow, false, 15, 370, "Rainbow", Sub_Colour2);

		AddNewSubMenuBox("Chams Team Visible", 140, 70, 130, 140, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(150, 90, 0, 255, 255, "Red", Tab_Other, Other_Cham_Team_Visible_Red, Sub_Colour2);
			AddNewSubSlider(150, 120, 0, 255, 138, "Green", Tab_Other, Other_Cham_Team_Visible_Green, Sub_Colour2);
			AddNewSubSlider(150, 150, 0, 255, 255, "Blue", Tab_Other, Other_Cham_Team_Visible_Blue, Sub_Colour2);
			AddNewSubSlider(150, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Team_Visible_Alpha, Sub_Colour2);
		}
		AddNewSubMenuBox("Chams Team Invisible", 140, 220, 130, 140, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(150, 240, 0, 255, 178, "Red", Tab_Other, Other_Cham_Team_inVisible_Red, Sub_Colour2);
			AddNewSubSlider(150, 270, 0, 255, 0, "Green", Tab_Other, Other_Cham_Team_inVisible_Green, Sub_Colour2);
			AddNewSubSlider(150, 300, 0, 255, 55, "Blue", Tab_Other, Other_Cham_Team_inVisible_Blue, Sub_Colour2);
			AddNewSubSlider(150, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Team_inVisible_Alpha, Sub_Colour2);
		}
		AddNewSubButton(Tab_Other, Other_Cham_Team_Rainbow, false, 140, 370, "Rainbow", Sub_Colour2);

		AddNewSubMenuBox("Chams Weapon", 275, 70, 130, 140, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(285, 90, 0, 255, 0, "Red", Tab_Other, Other_Cham_Weapon_Red, Sub_Colour2);
			AddNewSubSlider(285, 120, 0, 255, 255, "Green", Tab_Other, Other_Cham_Weapon_Green, Sub_Colour2);
			AddNewSubSlider(285, 150, 0, 255, 0, "Blue", Tab_Other, Other_Cham_Weapon_Blue, Sub_Colour2);
			AddNewSubSlider(285, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Weapon_Alpha, Sub_Colour2);
		}
		AddNewSubMenuBox("Custom Sky", 275, 220, 130, 110, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(285, 240, 0, 255, 0, "Red", Tab_Other, Other_Misc_Sky_Red, Sub_Colour2);
			AddNewSubSlider(285, 270, 0, 255, 0, "Green", Tab_Other, Other_Misc_Sky_Green, Sub_Colour2);
			AddNewSubSlider(285, 300, 0, 255, 0, "Blue", Tab_Other, Other_Misc_Sky_Blue, Sub_Colour2);
		}
		AddNewSubButton(Tab_Other, Other_Cham_Weapon_Rainbow, false, 275, 340, "Rainbow Weapon", Sub_Colour2);
		AddNewSubButton(Tab_Other, Other_Misc_Sky_Rainbow, false, 275, 370, "Rainbow Sky", Sub_Colour2);

		AddNewSubMenuBox("Custom Walls", 410, 70, 130, 140, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(425, 90, 0, 255, 255, "Red", Tab_Other, Other_Misc_CustomWalls_Red, Sub_Colour2);
			AddNewSubSlider(425, 120, 0, 255, 255, "Green", Tab_Other, Other_Misc_CustomWalls_Green, Sub_Colour2);
			AddNewSubSlider(425, 150, 0, 255, 255, "Blue", Tab_Other, Other_Misc_CustomWalls_Blue, Sub_Colour2);
			AddNewSubSlider(425, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Misc_CustomWalls_Alpha, Sub_Colour2);
		}
		

		AddNewSubMenuBox("Wireframe Hands", 410, 220, 130, 140, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(425, 240, 0, 255, 255, "Red", Tab_Other, Other_Misc_Wire_Red, Sub_Colour2);
			AddNewSubSlider(425, 270, 0, 255, 255, "Green", Tab_Other, Other_Misc_Wire_Green, Sub_Colour2);
			AddNewSubSlider(425, 300, 0, 255, 255, "Blue", Tab_Other, Other_Misc_Wire_Blue, Sub_Colour2);
			AddNewSubSlider(425, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Misc_Wire_Alpha, Sub_Colour2);
		}
		AddNewSubButton(Tab_Other, Other_Misc_Wire_Rainbow, false, 565, 340, "Rainbow Wireframe", Sub_Colour2);
		AddNewSubButton(Tab_Other, Other_Misc_CustomWalls_Rainbow, false, 415, 370, "Rainbow Walls", Sub_Colour2);

		AddNewSubMenuBox("Cham Hands", 565, 70, 130, 140, Tab_Other, Sub_Colour2);
		{
			AddNewSubSlider(565, 90, 0, 255, 0, "Red", Tab_Other, Other_Misc_Hands_Red, Sub_Colour2);
			AddNewSubSlider(565, 120, 0, 255, 0, "Green", Tab_Other, Other_Misc_Hands_Green, Sub_Colour2);
			AddNewSubSlider(565, 150, 0, 255, 0, "Blue", Tab_Other, Other_Misc_Hands_Blue, Sub_Colour2);
			AddNewSubSlider(565, 170, 0, 255, 255, "Alpha", Tab_Other, Other_Misc_Hands_Alpha, Sub_Colour2);
		}
		AddNewSubButton(Tab_Other, Other_Misc_Hands_Rainbow, false, 565, 370, "Rainbow Hands", Sub_Colour2);
	...
	AddNewMenuBox("Configs", 10, 80, 130, 180, Tab_Config);
	{
		...
		AddNewFuncButton(700, 350, (DWORD)Unhook, "Uninject", Tab_Config);
...
void DrawMenu()
{
	...
	if (Menu.Opened)
	{
		...
		Interfaces.pSurface->DrawT(Menu.pos.x + 820, Menu.pos.y + 30, CColor(232, 0, 0, 255), Hacks.Font_Tabplus, false, "R");
		Interfaces.pSurface->DrawT(Menu.pos.x + 820, Menu.pos.y + 60, CColor(232, 0, 0, 255), Hacks.Font_Tabplus, false, "E");
		Interfaces.pSurface->DrawT(Menu.pos.x + 820, Menu.pos.y + 90, CColor(232, 0, 0, 255), Hacks.Font_Tabplus, false, "V");
		Interfaces.pSurface->DrawT(Menu.pos.x + 820, Menu.pos.y + 120, CColor(232, 0, 0, 255), Hacks.Font_Tabplus, false, "E");
		Interfaces.pSurface->DrawT(Menu.pos.x + 820, Menu.pos.y + 150, CColor(232, 0, 0, 255), Hacks.Font_Tabplus, false, "N");
		Interfaces.pSurface->DrawT(Menu.pos.x + 820, Menu.pos.y + 180, CColor(232, 0, 0, 255), Hacks.Font_Tabplus, false, "G");
		Interfaces.pSurface->DrawT(Menu.pos.x + 820, Menu.pos.y + 210, CColor(232, 0, 0, 255), Hacks.Font_Tabplus, false, "E");
		Interfaces.pSurface->DrawT(Menu.pos.x + 820, Menu.pos.y + 240, CColor(232, 0, 0, 255), Hacks.Font_Tabplus, false, "R");

		Interfaces.pSurface->DrawSetColor(0, 0, 0, 144);
